...
% Fig. 2 of R. Contractor, G. D’Aguanno, C. Menyuk, “Ultra-broadband, polarization-
...
y = y((indx*3 + 1):(indx+1)*3);
end
%}

%% Inputs and Structure Parameters

y = 300.1:10:3000.1; % Range of wavelength in nm
